...
class Produit
{
    ...
    #[Assert\GreaterThan("now", message: "La date de debut de promo ne peut pas être dans le passé.")]
    ...
    public function setCategories(?Categorie $idCat): static
    {
        $this->Categories = $idCat;
